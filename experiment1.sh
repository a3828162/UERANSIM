...
QPS_List="15000 16000 17000 18000 19000 20000 "
...
for QPS in ${QPS_List}; do
    ...
    for i in {1..3}; do
        echo "Run: ${i} (Q=${Q})"
        dnsperf -s 192.168.56.110 -p 53 -Q ${Q} -c ${QPS} -T 4 -d queries.txt -l 30 > ./data/withEASDF_connectionpool_300/${QPS}_${i}.txt
        sleep 10
    done
done
